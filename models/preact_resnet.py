...
__all__ = ['ResNet', 'CIFAR_ResNet', 'CIFAR_ResNet101_Bottle', 'CIFAR_ResNet18_preActBasic', "CIFAR_ResNet50_Bottle", "CIFAR_ResNet152_Bottle"]
...
def CIFAR_ResNet50_Bottle(**kwargs):
    return CIFAR_ResNet(Bottleneck_CIFAR, [3,4,6,3], **kwargs)
def CIFAR_ResNet101_Bottle(**kwargs):
    return CIFAR_ResNet(Bottleneck_CIFAR, [3,4,23,3], **kwargs)
def CIFAR_ResNet152_Bottle(**kwargs):
    return CIFAR_ResNet(Bottleneck_CIFAR, [3,8,36,3], **kwargs)
