...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))  # SR_official
    ...
    def forward(self, x, is_feat=False, preact=False, is_adain=False, feat_s=None):  # feat_s : SR_official
        if feat_s is not None:  # SR_official
...
def wrn_10_10(**kwargs):
    model = WideResNet(depth=10, widen_factor=10, **kwargs)
    return model
